...
import 'package:el_horizonte/pages/bookmarks.dart';
import 'package:el_horizonte/pages/edit_profile.dart';
import 'package:el_horizonte/pages/subscriptions.dart';
import 'package:el_horizonte/pages/welcome.dart';
import 'package:el_horizonte/services/app_service.dart';
import 'package:el_horizonte/widgets/language.dart';
    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            //   onTap: () async => AppService().openLinkWithCustomTab(context, 'https://codecanyon.net/item/news-hour-flutter-news-app-with-admin-panel/25700781'),
            // ),
          ],
        ));
  }
        ...
        ListTile(
          ...
          leading: Container(
            ...
            decoration: BoxDecoration(
                color: Colors.blueAccent,
                borderRadius: BorderRadius.circular(5)),
            child: Icon(Feather.award, size: 20, color: Colors.white),
          ),
          trailing: Icon(
            Feather.chevron_right,
            size: 20,

...
import 'package:el_horizonte/widgets/full_image.dart';
import 'package:el_horizonte/widgets/iframe_player_widget.dart';
import 'package:el_horizonte/widgets/local_video_player.dart';
    ...
    return Html(
      ...
      style: {
        "body": Style(
          ...
          fontSize: fontSize == null ? FontSize(16.0) : FontSize(16.0),
